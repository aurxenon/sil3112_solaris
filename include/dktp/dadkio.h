 ...
 */
#ifdef _SYSCALL32
typedef struct sol11dadk_ioc_string32
{
	caddr32_t	is_buf;		/* pointer to character array */
	int		is_size;	/* string length */
} sol11dadk_ioc_string32_t;
#endif /* _SYSCALL32 */

typedef struct sol11dadk_ioc_string
{
	caddr_t		is_buf;		/* pointer to character array */
	int 		is_size;	/* string length */
} sol11dadk_ioc_string_t;
...
struct	sol11dadkio_derr {
	int	d_action;
	int	d_severity;
};

/*
 *  sol11dadkio_rwcmd cmd
 */
...
/*
 * sol11dadkio_status status value.
 */
struct sol11dadkio_status {
	int		status;
	ulong_t		resid;
 ...
 */
struct sol11dadkio_rwcmd {
	int			cmd;
	int			flags;
	daddr_t			blkaddr;
	uint_t			buflen;
	caddr_t			bufaddr;
	struct sol11dadkio_status	status;
};

#ifdef _SYSCALL32
struct sol11dadkio_rwcmd32 {
	int			cmd;
	int			flags;
	daddr32_t		blkaddr;
	uint_t			buflen;
	caddr32_t		bufaddr;
	struct sol11dadkio_status32	status;
};
#endif /* _SYSCALL32 */

/*
 * sol11dadkio_status status values
 */
